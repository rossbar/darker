...
@pytest.mark.kwparametrize(
    dict(
        revision="",
        worktree_content="USERMOD=1\n",
        expect=["+1", "+1M0", "+2-1", "+2", "+2M1-0", "+2M1"],
    ),
    dict(
        revision="",
        worktree_content="ORIGINAL=1\n",
        expect=["+1M0", "+2-1", "+2M1-0", "+2M1"],
    ),
    dict(
        revision="",
        worktree_content="MODIFIED=1\n",
    ...
    dict(revision="HEAD~2", worktree_content="ORIGINAL=1\n", expect=["+1", "+1M0"]),
    dict(
        revision="HEAD~2",
        worktree_content="MODIFIED=1\n",
        expect=["+1", "+1M0", "+2-1", "+2", "+2M1-0", "+2M1"],
    ),
    dict(revision="HEAD~3", worktree_content="USERMOD=1\n", expect=SystemExit),
)
